...
def main(scenario_index=-2):
    ...
    checkpt_dir = os.path.expanduser("~/Test_data/")
    ...
    default_scenario = {'actuator_names': ['pinj', 'curr', 'tinj','gasA'],
                        ...
                        'epochs': 200,
                        'flattop_only': True,
                        'raw_data_path': '/scratch/gpfs/jabbate/small_data.pkl', #'/scratch/gpfs/jabbate/full_data/train_data_full.pkl', #'/projects/EKOLEMEN/profile_predictor/DATA/full_data_with_error/small_data.pkl',#'/scratch/gpfs/jabbate/small_data.pkl', #/scratch/gpfs/jabbate/mixed_data/final_data.pkl 
                        'process_data': True,
                        'optimizer': 'adagrad',
                        'optimizer_kwargs': {},
    ...
    if scenario_index == -1:
        make_bash_scripts(num_scenarios, checkpt_dir,
                          num_cores, ngpu, req_mem, runtimes, mode='autoencoder_batch')
