...
if True:
    ...
    with open(os.path.join(processed_filename_base,'train_{}.pkl'.format(rank)),'rb') as f:
        traindata=pickle.load(f)
    with open(os.path.join(processed_filename_base,'val_{}.pkl'.format(rank)),'rb') as f:
